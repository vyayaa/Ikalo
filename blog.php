...
<html lang="en">
   ...
   <body class="main-layout position_head">
      ...
      <!-- end header -->
      <!-- Our shop section -->
      <h1 class="fw-bolder mb-1">Selamat datang di Posting Blog IKALOG!</h1>
      <div class="text-muted fst-italic mb-2">dipost dalam November, 11. 2021. 01.32</div>
      <div id="about" class="shop">
         <div class="container-fluid">
            <div class="row">
               <div class="col-md-5">
                  <div  class="shop_img">
                     <figure><img src="images/ikaloglogo.jpeg" alt="#" ></figure>
                  </div>
               </div>
               <br>
               <br>
               <div class="titlepage" style="color: #211104">
             <h2>Tentang IKALOG</h2>
                <p>IKALOG adalah halaman website yang dapat memudahkan dan menghemat waktu Anda dalam mengatur tata letak logo brand Anda, serta membuatnya lebih mudah dikenali oleh orang-orang di sekitar Anda.</p>
             </div>
             <br>
             <br>
             <div class="titlepage" style="color: #211104;">
                <h3>Tujuan pembuatan website IKALOG</h3>
                <p>Website IKALOG pada awalnya dibuat dengan tujuan untuk membantu para desainer untuk menyalurkan ide-idenya dalam membuat logo sesuai dengan keinginan orang lain, selain itu website ini juga ditujukan agar masyarakat lebih percaya diri dalam menjalankan bisnisnya sendiri dan untuk membantu mereka yang sedang merintis usaha. namun masih minimnya pengetahuan dalam mendesain, sehingga website ini diterbitkan karena hal-hal yang tertulis di atas.</p>
             </div>
