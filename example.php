   ...
   <body class="main-layout position_head">
    ...
    <div class="card" style="width: 18rem;">
          ...
          <div class="card" style="width: 18rem;">
            <figure><img src="images/logo8.jpg" alt="#" style="padding-left: 60px; padding-top: 10px;" /></figure>
            <div class="card-body">
              <p class="card-text"> tema imajinasi</p>
            </div>
          </div>
          <br>
                          <br>
    <div class="card" style="width: 18rem;">
            <figure><img src="images/logo4.jpg" alt="#" style="padding-left: 60px; padding-top: 10px;" /></figure>
            <div class="card-body">
              <p class="card-text">tema fantasi</p>
            </div>
          </div>
          <br>
          <div class="card" style="width: 18rem;">
          ...
          <div class="card" style="width: 18rem;">
            <figure><img src="images/logo8.jpg" alt="#" style="padding-left: 60px; padding-top: 10px;" /></figure>
            <div class="card-body">
              <p class="card-text">tema futuristik</p>
            </div>
          </div>
          <br>
                          <br>
    <div class="card" style="width: 18rem;">
            <figure><img src="images/logo4.jpg" alt="#" style="padding-left: 60px; padding-top: 10px;" /></figure>
            <div class="card-body">
              <p class="card-text">tema bisnis</p>
            </div>
          </div>
          <br>
          <div class="card" style="width: 18rem;">
            <figure><img src="images/logo9.jpg" alt="#" style="padding-left: 60px; padding-top: 10px;" /></figure>
            <div class="card-body">
              <p class="card-text">tema sketsa</p>
            </div>
          </div>
      </div>
      <br>
